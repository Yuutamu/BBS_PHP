...
if (isset($_SESSION['id']) && $_SESSION['time'] + 3600 > time()) {
  // ログインしている(=セッションにidが残っているかつ、最後の行動から60分（60*60秒）以内である)
  $_SESSION['time'] = time();
  // $SESSION[time]を今の時間で上書き
...
<div id="wrap">
  ...
  <div id="content">
    ...
    <!-- 手動投稿 -->
    <div class="msg">
    <imag src="member_picture/20230318082411MiConv.com__ユニコーン.jpg" width="48" alt="ゆにこーん" />
    <p>
        ゆうたむ！かわいい！まぢ天使！(◕‿◕✿)
        <span class="name">(おじさんA)</span>
    </p>
    <p class="day">
        2023/04/10 14:24
    </p>
